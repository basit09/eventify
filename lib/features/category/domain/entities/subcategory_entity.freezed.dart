...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SubcategoryEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
...
class _SubcategoryEntity implements SubcategoryEntity {
  const _SubcategoryEntity({required this.id, required this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SubcategoryEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
