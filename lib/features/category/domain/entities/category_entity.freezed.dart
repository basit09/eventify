...
mixin _$CategoryEntity {
 ...
 String get id; String get name; List<SubcategoryEntity> get subcategories;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoryEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.subcategories, subcategories));
}
...
@useResult
$Res call({
 String id, String name, List<SubcategoryEntity> subcategories
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  List<SubcategoryEntity> subcategories)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  List<SubcategoryEntity> subcategories)  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity():
return $default(_that.id,_that.name,_that.subcategories);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  List<SubcategoryEntity> subcategories)?  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
return $default(_that.id,_that.name,_that.subcategories);case _:
  return null;
...
class _CategoryEntity implements CategoryEntity {
  const _CategoryEntity({required this.id, required this.name, final  List<SubcategoryEntity> subcategories = const []}): _subcategories = subcategories;
...
@override@JsonKey() List<SubcategoryEntity> get subcategories {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CategoryEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._subcategories, _subcategories));
}
